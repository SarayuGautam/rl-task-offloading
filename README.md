...
**Headline result (re-verified 2026-09-12):** the agent beats the strongest fixed baseline (Always-Cloud) by **9.13% ± 1.05%** composite cost across 5 seeds (t(4) = 24.399, p = 0.00002), and the simulator matches M/M/1 queuing theory to within 0.39%.

## Key documents

- `PROJECT_STATUS.md` — master status note, verified numbers, known divergences between report text and artifacts
- `../../DEFENSE_GUIDE.md` — plain-language defense preparation document (workspace root)
- `../../EGPG600_Report_SarayuGautam.docx` — the final report (deliverable; §4.4 corrected 2026-09-12)
